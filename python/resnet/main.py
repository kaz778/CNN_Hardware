...
#       with open("./result_data//resnet_cifar100_1-3_floor(2^k).pickle", "wb") as f:
#             pickle.dump(result, f)

      if w == 1:
        if a == 1:
            with open("./result_data//resnet_cifar100_1-1_round(2^k).pickle", "wb") as f:
                   pickle.dump(result, f)
        elif a == 2:
            with open("./result_data//resnet_cifar100_1-2_round(2^k).pickle", "wb") as f:
                   pickle.dump(result, f)
        elif a == 3:
            with open("./result_data//resnet_cifar100_1-3_round(2^k).pickle", "wb") as f:
                   pickle.dump(result, f)
        elif a == 4:
            with open("./result_data//resnet_cifar100_1-4_round(2^k).pickle", "wb") as f:
                   pickle.dump(result, f)
      elif w == 2:
        if a == 1:
            with open("./result_data//resnet_cifar100_2-1_round(2^k).pickle", "wb") as f:
                   pickle.dump(result, f)
        elif a == 2:
            with open("./result_data//resnet_cifar100_2-2_round(2^k).pickle", "wb") as f:
                   pickle.dump(result, f)
        elif a == 3:
            with open("./result_data//resnet_cifar100_2-3_round(2^k).pickle", "wb") as f:
                   pickle.dump(result, f)
        elif a == 4:
            with open("./result_data//resnet_cifar100_2-4_round(2^k).pickle", "wb") as f:
                   pickle.dump(result, f)
      elif w == 3:
        if a == 1:
            with open("./result_data//resnet_cifar100_3-1_round(2^k).pickle", "wb") as f:
                   pickle.dump(result, f)
        elif a == 2:
            with open("./result_data//resnet_cifar100_3-2_round(2^k).pickle", "wb") as f:
                   pickle.dump(result, f)
        elif a == 3:
            with open("./result_data//resnet_cifar100_3-3_round(2^k).pickle", "wb") as f:
                   pickle.dump(result, f)
        elif a == 4:
            with open("./result_data//resnet_cifar100_3-4_round(2^k).pickle", "wb") as f:
                   pickle.dump(result, f)
      elif w == 4:
        if a == 1:
            with open("./result_data//resnet_cifar100_4-1_round(2^k).pickle", "wb") as f:
                   pickle.dump(result, f)
        elif a == 2:
            with open("./result_data//resnet_cifar100_4-2_round(2^k).pickle", "wb") as f:
                   pickle.dump(result, f)
        elif a == 3:
            with open("./result_data//resnet_cifar100_4-3_round(2^k).pickle", "wb") as f:
                   pickle.dump(result, f)
        elif a == 4:
            with open("./result_data//resnet_cifar100_4-4_round(2^k).pickle", "wb") as f:
                   pickle.dump(result, f)
